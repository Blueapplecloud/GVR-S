...
function Founder() {
  ...
  return (
    <div className="container m-10 bg-white shadow-lg rounded-md py-10 px-5">
      <motion.h1
        ref={ref}
        // key={index}
      ...
      <div>
        ...
        <p className="text-justify">
          We, in GVR&S, have a simple answer. We believe in the success of an
        ...
        <p className="text-justify">
          At GVR&S, we believe in our students to become the high-profiled
          professionals who can achieve the avowed objective of our great
          president, Hon'ble Abdul Kalam, to make our country a "SUPER POWER".
        </p>
      </div>
