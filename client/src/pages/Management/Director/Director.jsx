...
function Director() {
    ...
    return (
        <div className="container mx-auto my-6 px-4 py-6 bg-white shadow-lg rounded-m">
            <motion.h1
                ref={ref}
                // key={index}
                ...
                className="text-2xl sm:text-3xl md:text-4xl font-bold text-left mb-6 ml-5"
            >
                Director
            ...
            <div >
                <img
                    ...
                    className=" w-full max-w-[700px] h-auto float-start rounded-lg shadow-lg p-5"
                />
            ...
            <div className="text-end">
                ...
                <p><strong className='!mb-4 text-Red'>SHAIK KAREEMOON</strong></p>
