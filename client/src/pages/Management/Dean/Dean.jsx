    ...
    <div className="container mx-auto my-6 px-4 py-6 bg-white shadow-lg rounded-md">
      ...
      <div className="flex flex-col lg:flex-row lg:items-start lg:space-x-8">
        ...
        <div className="flex-1 text-justify">
          ...
          <div className="mt-6">
            <a
              href="/management/dean"
              className="border border-Amber bg-primaryColor hover:bg-Amber text-white px-10 py-3 text-lg font-sans font-semibold rounded-md hover:!text-black transition duration-200 ease-in-out"
            >
              View More &gt;&gt;
            </a>
          </div>
        ...
        {/* Image */}
        <div className="mt-6 lg:mt-0 lg:w-72 text-center">
