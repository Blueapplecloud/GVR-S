       ...
       return (
           <div className="container m-10 bg-white shadow-lg rounded-md ">
               ...
               <div >
                   ...
                   <img src="https://gvrs.ac.in/wp-content/uploads/2023/06/dean-248x300.jpg" className=" float-end m-5 mt-0 h-90 rounded-lg shadow-lg" />
                   ...
                   <strong className='mt-5 text-[#b04040]'>PROFILE:</strong><br/><br/>
                   <strong className='mt-5 text-[#b04040]'>EDUCATIONAL QUALIFICATION:</strong>
                    <p className='mt-3'> <b>Ph.D: </b> Quality of work Life in Banks – <b>A Study with reference to Andhra Bank
                    and ICICI Bank,</b> Acharya Nagarjuna University.</p>
