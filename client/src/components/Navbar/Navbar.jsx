...
const CustomNavbar = () => {
  ...
  const dropdownItemClass =
    "bg-white text-black hover:!text-[#B04040] hover:!bg-[#F5F5F5]";
          ...
          <Nav className="mx-auto text-center">
            ...
            >
              <div className="flex gap-4 px-3 py-2">
                ...
                >
                  <NavDropdown
                    title={
                      <span className="text-black hover:text-[#B04040]">
                        UG
                      </span>
                    }
                    show={dropdownStates.showUG}
                    drop="end"
                  >
                    <NavDropdown.Item
                      as={Link}
                ...
                >
                  <NavDropdown
                    title={
                      <span className="text-black hover:text-transparent">
                        PG
                      </span>
                    }
                    show={dropdownStates.showPG}
                    drop="end"
                  >
                    <div
                    ...
                    >
                      <NavDropdown
                        ...
                        show={dropdownStates.showMBA}
                        drop="end"
                      >
                        <NavDropdown.Item
                          as={Link}
                          to="/departments/mba-finance"
                          className={dropdownItemClass}
                        >
                          Finance
                        </NavDropdown.Item>
                    ...
                    >
                      <NavDropdown
                        ...
                        show={dropdownStates.showMTech}
                        drop="end"
                      >
                        <NavDropdown.Item
                          as={Link}
                          to="/departments/mtech-cse"
                          className={dropdownItemClass}
                        >
                          CSE
                        </NavDropdown.Item>
            ...
            >
              ...
              >
                <NavDropdown
                  title={
                    <span className="text-black hover:text-white ml-2">
                      {"Gallery"}
                    </span>
                  }
                  show={dropdownStates.showGallery}
                  drop="end"
                >
                  <NavDropdown.Item
                    as={Link}
                    to="/gallery/culturals"
                    className={dropdownItemClass}
                  >
                    Culturals
                  </NavDropdown.Item>
